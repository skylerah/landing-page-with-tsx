...
import './DesignedForFuture.scss';
import editorImage from '../../assets/illustration-editor-desktop.svg'; // Ensure you have this image in the specified path

const DesignedForFuture: React.FC = () => {
  return (
